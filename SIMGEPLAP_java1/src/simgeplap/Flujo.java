...
public static class LectorFlujo extends JPanel implements Runnable {// implements Runnable quiere decir que implementará el comportamiento de un hilo
    ...
    private DefaultValueDataset datasetF;
    private int lecF;  // lec de lectura, F de flujo
    protected Random dado;
        ...
        public LectorFlujo() {
            ...
            datasetF = new DefaultValueDataset(10D);
            ...
            manometroT.setDataset(0, datasetF);
            ...
            while (true) { // while true para que el ciclo sea indefinido
                try {
                    ...
                    if (dado.nextInt(200) == dado.nextInt(210)) {// dado es un objeto de la clase random, en esta linea le digo que lanse 2 dados, uno 
                        ...
                        lecF = dado.nextInt(100);//... la lectura sera al azar en una rango de 0 a 100
                        datasetF.setValue(lecF);// luego se la pasamos al valor que debe señalar la aguja del monitor

                        if (lecF < SIMGEPLAP.minF || lecF > SIMGEPLAP.maxF) {
                      
                            String mensajeAlerta = "!Lecturas de presión de Flujo Anormales, lectura: " + lecF;
                            
                    //        ¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬|
                            //Cuadro de Dialogo JOptionPane -->
                       Controlador.Incidencias.WaitToSend("nivel de Flujo inseguro, registrar Alerta?", mensajeAlerta, "Flujo", lecF );
                    //¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬
                       ...
                       //     Incidencias.TomandoEleccion();
                        ...
                        lecF = dado.nextInt(SIMGEPLAP.maxF - SIMGEPLAP.minF) + SIMGEPLAP.minF;
                        datasetF.setValue(lecF);
                        Thread.sleep(retardo);
                    }
