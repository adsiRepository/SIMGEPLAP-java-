            ...
            while (true) { // es decir que será un bucle indefinido
                try {
                    ...
                    if (dado.nextInt(350) == dado.nextInt(350)) {// probabilidad, estoy tirando 2 dados 1 de a lados y otro de b lados
                                    // si caen par ->
                        lecT = dado.nextInt(190);//la lectura será al azar entre 0 y 190
                        
                        datasetT.setValue(lecT);  // lo agregará a los datos del reloj

                        if (lecT < SIMGEPLAP.minT || lecT > SIMGEPLAP.maxT) {//si lecT está fuera de estos números entonces...
...
//¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬|
                        ...
                        lecT = dado.nextInt(SIMGEPLAP.maxT - SIMGEPLAP.minT) + SIMGEPLAP.minT;
                        datasetT.setValue(lecT);
                        Thread.sleep(retardo);
                    }
